drop function if exists public.admin_list_attendance(uuid, text);
drop function if exists public.admin_list_attendance(text, uuid);

create function public.admin_list_attendance(
...
revoke all on function public.admin_list_attendance(text, uuid) from public, anon;
grant execute on function public.admin_list_attendance(text, uuid) to authenticated;
